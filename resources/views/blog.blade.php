			...
			<div class="row">
				<div class="col-md-8">
					...
					@foreach($data as $postingan_terbaru)
						<div class="col-md-6">
							<div class="post">
								<a class="post-img" href="{{route('blog.isi', $postingan_terbaru->slug)}}"><img src="{{ $postingan_terbaru->gambar }}" alt="" style="height: 200px"></a>
								<div class="post-body">
									<div class="post-category">
										<a href="#">{{$postingan_terbaru->category->name}}</a>
									</div>
									<h3 class="post-title"><a href="{{route('blog.isi', $postingan_terbaru->slug)}}">{{$postingan_terbaru->judul}}</a></h3>
									<ul class="post-meta">
